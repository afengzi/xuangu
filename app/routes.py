...
from app.interface.get_info import get_factors_info, get_themes_info, get_multi_theme_and_factor_all_info, get_detail_info_by_code, get_themes_key, get_zhibiao_info, get_zhibiao_factor_theme_info
