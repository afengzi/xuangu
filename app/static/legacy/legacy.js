  ...
  new Vue({
    ...
    data: function() {
      return {
        themes: [],
        selectedThemes: [],
        indicatorOptions: ['打板','抄底','低吸','追涨','龙头'],
        indicator: '',
        // 题材"更多"弹窗可见性（使用现成弹窗脚本绑定 appRef.themesDialog）
        themesDialog: false,
        // 因子配置（保持与模板兼容）
        basicFactors: ['营业收入','市盈率','销售毛利率','ROE','净利润','市净率','资产负债率'],
        technicalFactors: ['MACD','KDJ','BOLL','单k组合','均线'],
        capitalFactors: ['大单净量','大单净额','陆股通净流入'],
        selectedFactorMap: {},
        tempFactorMap: {},
        factorPopoverVisible: {},
        selectedFactors: [],
        factorRanges: {
          '营业收入': ['5以下','5~10','10~20','20~50','50以上'],
          '市盈率': ['10以下','10~20','20~30','30~40'],
          '销售毛利率': ['5以下','5~20','20~35','35~40','40以上'],
          'ROE': ['5以下','5~10','10~20','20以上'],
          '净利润': ['亏损','0~1','1~3','3~5','5以上'],
          ...
          '大单净额': ['小于0','0~1000','1000~5000','大于5000'],
          '陆股通净流入': ['小于0','0~1000','1000~5000','5000~10000','大于10000']
        },
        tableData: [],
        pageSize: 20,
        currentPage: 1
